...
var cheerioHtmlUrl = function(url) {
   ...
   console.log("im here 2 " + req.response);
         
   if (req.response instanceof Error) {
       return cheerio.load ("<html><body>error loading url:" + url + "</body></html>");
     } else {
       return cheerio.load(req.response);
     }      
};
